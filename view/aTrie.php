    ...
    <main>
        ...
        <section id="projects">
            <div class="container FundoProjetos">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="text-center TituloProjetos">Arvore Trie</h1>
                    </div>
                </div>
                <img class="card-img-top BordaDetalheVermelho" src="../IMG/ArvoreTrie.png" alt="Card image cap">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4 CardProjetos">
                            <div class="card-body BordaDetalheVermelho Texto-DarkProjeto">
                                ...
                                <a href="Trie/inserindoB.html" class="Botao-Principais">Aprender</a>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4 CardProjetos">
                            <div class="card-body BordaDetalheVermelho Texto-DarkProjeto">
                                ...
                                <a href="Trie/buscaB.html" class="Botao-Principais">Aprender</a>
                    ...
                    <div class="col-md-6">
                        <div class="card mb-4 CardProjetos">
                            <div class="card-body BordaDetalheVermelho Texto-DarkProjeto">
                                ...
                                <a href="Trie/removendoB.html" class="Botao-Principais">Aprender</a>
