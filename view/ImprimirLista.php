        ...
        <div class="container my-5 d-flex justify-content-center align-items-center flex-column" style="display: flex; justify-content: center; align-items: center; flex-direction: column">
          <div class="row">
            <div class="col-md-6 mb-4 mb-md-0">
              ...
              <h2 class="font-weight-bold">Imprimindo os valor da lista</h2>
                  ...
                  <div class="col-md-6">
                        <div class="card mb-4 CardProjetos">
                            ...
                            <div class="card-body BordaDetalheVermelho Texto-DarkProjeto">
                              ...
                              <br><br>Imprimir: É o método responsável por imprimir os valores da lista. Ele percorre a lista a partir do head e imprime o valor de cada nó usando um loop while. A cada iteração, ele move current para o próximo nó até que current seja nulo, indicando o fim da lista. Durante a impressão, cada valor é exibido na tela usando Console.WriteLine.
                              </p>
